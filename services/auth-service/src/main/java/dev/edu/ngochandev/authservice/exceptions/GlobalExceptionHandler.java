...
import dev.edu.ngochandev.authservice.dtos.res.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleGlobalException(Exception ex, WebRequest req) {
    ...
    public ErrorResponse handleValidationExceptions(MethodArgumentNotValidException ex, WebRequest req) {
        ErrorResponse res = new ErrorResponse();
        res.setPath(req.getDescription(false).replace("uri=", ""));
    ...
    public ErrorResponse handleDuplicateResourceException(DuplicateResourceException ex, WebRequest req) {
        ErrorResponse res = new ErrorResponse();
        res.setPath(req.getDescription(false).replace("uri=", ""));
