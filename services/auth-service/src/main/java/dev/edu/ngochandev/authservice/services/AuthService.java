...
public interface AuthService {
    Long register(UserRegisterRequestDto req, String orgSlug) throws JOSEException;
    ...
    Boolean forgotPassword(UserForgotPasswordRequestDto req) throws JOSEException;
